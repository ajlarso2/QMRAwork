...
v1 <- cw.vl.ln[sample(nrow(cw.vl.ln), div5.nsu, replace = TRUE), list(g_v1_ln)]
colnames(v1) <- c("cw.vals")
v11 <- cw.vl.ln[sample(nrow(cw.vl.ln), div5.nsu, replace = TRUE), list(g_v11_ln)]
colnames(v11) <- c("cw.vals")
v2 <- cw.vl.ln[sample(nrow(cw.vl.ln), div5.nsu, replace = TRUE), list(g_v2_ln)]
colnames(v2) <- c("cw.vals")
v5 <- cw.vl.ln[sample(nrow(cw.vl.ln), div5.nsu, replace = TRUE), list(g_v5_ln)]
colnames(v5) <- c("cw.vals")
v9 <- cw.vl.ln[sample(nrow(cw.vl.ln), div5.nsu, replace = TRUE), list(g_v9_ln)]
colnames(v9) <- c("cw.vals")
cw.vlg2 <- unlist(c(v1$cw.vals,v11$cw.vals,v2$cw.vals,v5$cw.vals,v9$cw.vals))
...
expo.mod1 <- mcmodel({
  ...
  exporaw.uv <- (exporaw.mc1 * .0001)
    ...
    #Reduction by porous ceramic filtration based on the distribution entered lines 93-99:
