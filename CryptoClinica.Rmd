---
title: "2D Monte Carlo Simulation of Risk of Cryptosporidium Infection from Roof-Collected Rainwater in the USVI Using mc2d - Clinical infection dose-response version"
...
kvalues <- rbind(k_dup,k_tamu)
num.kvals <- as.numeric(kvalues$x)
```
