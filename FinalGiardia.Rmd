...
expo.mod1 <- mcmodel({
  ...
  mc(cw.vl2, cw.vl, dw.ing, hosing, shower, exporaw.5ppm_fcl, exporaw.uv,  pfc_reduc, exporaw.pfc_reduc, k1, k2, k, expo.mc1, dose, risk1, risk, yearrisk, risk.raw, dose.raw, yearrisk.raw,risk.chl, dose.chl, yearrisk.chl,risk.uv, dose.uv, yearrisk.uv,risk.pcf, dose.pcf, yearrisk.pcf) 
})
```
