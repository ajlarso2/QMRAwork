...
expo.mod1 <- mcmodel({
  ...
  #Reduction by 15ppm free chlorine:
    ...
    #Reduction by one or the other:
    exporaw.freechl.tog <- mcstoc(rempiricalD, values = c(.47,.4904), prob = c(.5,.5), type = "VU")
  ...
  mc(cw.vl, dw.ing, hose.perevent, shower.perevent, exporaw.2ppm_free_chl, exporaw.15ppm_free_chl, exporaw_free_chl, exporaw.uv, exporaw.uv_2ppm_chl_cerfilt, exporaw.2ppm_chl_cerfilt, exporaw.porous_ceram, pfc_reduc,  a, n50, k, expo.mc1, dose, riskbp, risk1, risk, yearrisk) 
})
```
