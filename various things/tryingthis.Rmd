...
expo.mod1 <- mcmodel({
  ...
  cw.vl_jul92 <- dnorm(hm, mean = 0.75, sd = 1.57)
  
  cw.vl_jan93 <- dnorm(hm, mean = 11.61, sd = 25.94)
  
  cw.vl_apr93 <- dnorm(hm, mean = 1.25, sd = 2.59)
  
  cw.vl_jun93 <- dnorm(hm, mean = 3.52, sd = 4.97)
  
  huh <- c(cw.vl_jul92, cw.vl_jan93, cw.vl_apr93, cw.vl_jun93)
  
  cw.vl_seas <- mcstoc(rempiricalD, type = "VU", seed = seed, 
                             values = c(0.75, 11.61, 1.25, 3.52), prob = c(0.25, 0.25, 0.25, 0.25))
